...
export function HerdStatusCard({
  ...
  return (
    <Card className={cn("overflow-hidden flex flex-col", className)} size="sm">
      ...
      {currentlyMilking !== undefined && (
        <div className="mt-auto border-t border-slate-100 dark:border-white/5 px-4 py-2">
          <div className="flex items-center justify-between">
            <span className="text-[11px] font-medium text-[#8A93A2] dark:text-muted-foreground/80">
              W hali dojenia teraz
            </span>
            <span className="text-[12px] font-semibold text-[#131720] dark:text-foreground">
