import type { Cow, HerdSummary, FeedEvent, CowYieldDay, CowActivityDay } from '@/lib/types/stado.types'
...
export const MOCK_COWS: Cow[] = [
  {
    ...
    offspring: [
      { id: 'c1', earTagNumber: 'PL 005400112233', sex: 'female', birthDate: '2023-01-10', status: 'Odchów' }
    ],
